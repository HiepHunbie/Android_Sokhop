...
public class ListHistoryActivityAdapter extends BaseAdapter {
    ...
    public ListHistoryActivityAdapter(Activity a, String[] desc, String[] imageid) {
        activity = a;
        this.messages = desc;
        this.times = imageid;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi=convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout.item_list_history_activity, null);
