...
public class QuanLyUngVienAdapter extends BaseAdapter {
    ...
    public QuanLyUngVienAdapter(MainActivity a, ArrayList<String> logo, ArrayList<String> title, ArrayList<String> company, ArrayList<String> time,
                                 ArrayList<String> other, ArrayList<String> location, ArrayList<String> exp, ArrayList<String> time_type,ArrayList<String> recruiter_id) {
        activity = a;
        this.logo = logo;
        this.title = title;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        View vi=convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout.item_quanly_ungvien, null);
