...
public class HttpGetAllApplyJob extends API {

    private String access_token ;
    private String page_id;
    public HttpGetAllApplyJob(Activity context, String token, String id) {
        super(context);
        access_token = token;
        page_id = id;
    }
    ...
    protected String getUrl() {
        return APIConstants.GET_ALL_APPLY_JOB_URL +"?access_token="+ access_token+"&page="+page_id;
    }
