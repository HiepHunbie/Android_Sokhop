...
public class HttpGetExperices extends API {

    private String access_token ;
    private String user_id;
    public HttpGetExperices(Activity context, String token, String id) {
        super(context);
        access_token = token;
        user_id = id;
    }
    ...
    protected String getUrl() {
        return APIConstants.GET_EXPERICES_URL +"?access_token="+ access_token+"&user_id="+user_id;
    }
