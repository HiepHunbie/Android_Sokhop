...
public class DeletedRecruitmentFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_deleted_recruitment, container, false);
        mActivity.databaseHelper.deleteAllRecruitment();
        recruitmentModels = new ArrayList<>();
        getRecruitment(mActivity.p.getString(Pref.PREF_KEY_TOKEN,null),0,"5","1","10");
        ...
        SwipeMenuCreator creator = new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                ...
                SwipeMenuItem khoiphuc = new SwipeMenuItem(
                        mActivity);
                khoiphuc.setBackground(R.color.recruitment2);
                khoiphuc.setWidth((int) mActivity.getResources().getDimension(R.dimen._80sdp));
                khoiphuc.setTitleSize(15);
                khoiphuc.setTitleColor(Color.WHITE);
                khoiphuc.setTitle(getString(R.string.restore));
                menu.addMenuItem(khoiphuc);
            ...
            public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                switch (index) {
                    case 0:
                        ...
                        if(response == 200){
                            DialogCall.showResponse(mActivity, mActivity.getString(R.string.khoiphuc_success), new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    int id = v.getId();
                                    if (id == R.id.btnOk) {
                                        QuanLyTinTuyenDungFragment.selectItem(4);
                                    }
                                }
                            });
                        }else {
                            DialogCall.showResponse(mActivity, mActivity.getString(R.string.khoiphuc_error), new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    int id = v.getId();
                                    if (id == R.id.btnOk) {
                        ...
                        break;
                    case 1:
                        int responsess = HttpUpdateStatusRecruitment.deleteRecruitment(mActivity.p.getString(Pref.PREF_KEY_TOKEN,null),JobId.get(position),"0");
                        if(responsess == 200){
                            DialogCall.showResponse(mActivity, mActivity.getString(R.string.delete_forever_success), new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    int id = v.getId();
                                    if (id == R.id.btnOk) {
                            ...
                            DialogCall.showResponse(mActivity, mActivity.getString(R.string.delete_forever_error), new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    int id = v.getId();
                                    if (id == R.id.btnOk) {
            ...
            private void isScrollCompleted() {
                ...
                if (currentFirstVisibleItem + currentVisibleItemCount >= currentTotalItemCount) {
                    if (this.currentVisibleItemCount > 0
                        ...
                        refreshValue+=1;
                        getRecruitment(mActivity.p.getString(Pref.PREF_KEY_TOKEN,null),0,"5", String.valueOf(refreshValue),"10");
                    }
                }
            }
        });
...
//                            String job_location = jsonObject.getString("");
                        ...
                        recruitmentModels = mActivity.databaseHelper.getARecruitment(5);
