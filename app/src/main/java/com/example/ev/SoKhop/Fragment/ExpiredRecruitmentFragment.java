...
public class ExpiredRecruitmentFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_expired_recruitment, container, false);
        mActivity.databaseHelper.deleteAllRecruitment();
        recruitmentModels = new ArrayList<>();
        getRecruitment(mActivity.p.getString(Pref.PREF_KEY_TOKEN,null),0,"4","1","10");
        ...
        SwipeMenuCreator creator = new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                ...
                giahan.setTitle(getString(R.string.giahan));
            ...
            public boolean onMenuItemClick(int position, SwipeMenu menu, int index) {
                switch (index) {
                    case 0:
                        ...
                        mActivity.p.putString(Pref.PREF_KEY_STATUS_ID,"4");
                    ...
                    case 1:
                        ...
                        if(response == 200){
                            DialogCall.showResponse(mActivity, mActivity.getString(R.string.giahan_success), new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    int id = v.getId();
                                    if (id == R.id.btnOk) {
                                        QuanLyTinTuyenDungFragment.selectItem(3);
                                    }
                                }
                            });
                        }else {
                            DialogCall.showResponse(mActivity, mActivity.getString(R.string.giahan_error), new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    int id = v.getId();
                                    if (id == R.id.btnOk) {
            ...
            private void isScrollCompleted() {
                ...
                if (currentFirstVisibleItem + currentVisibleItemCount >= currentTotalItemCount) {
                    if (this.currentVisibleItemCount > 0
                        ...
                        refreshValue+=1;
                        getRecruitment(mActivity.p.getString(Pref.PREF_KEY_TOKEN,null),0,"4", String.valueOf(refreshValue),"10");
                    }
                }
            }
        });
...
//                            String job_location = jsonObject.getString("");
                        ...
                        recruitmentModels = mActivity.databaseHelper.getARecruitment(4);
