...
import com.example.ev.SoKhop.Adapter.ListHistoryActivityAdapter;
...
public class HistoryActvityFragment extends BaseFragment {
    ...
    public HistoryActvityFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View rootView = inflater.inflate(R.layout.fragment_history_activity, container, false);
        listViewMessage = (SwipeMenuListView)rootView.findViewById(R.id.listViewMessage);
        ListHistoryActivityAdapter customList = new ListHistoryActivityAdapter(mActivity, desc, imageid);
