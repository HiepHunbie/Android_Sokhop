...
public class QuanTamNotificationFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab_info_2, container, false);
        mActivity.databaseHelper.deleteAllNotification();
        notificationModels = new ArrayList<>();
        getNotification(mActivity.p.getString(Pref.PREF_KEY_TOKEN,null),"2","1","10");
        listView = (SwipeMenuListView)rootView.findViewById(R.id.listView);
        customList = new TabInfoAdapter(mActivity, names, messages, times,quantam,isRead,notify_ids,1);
            ...
            private void isScrollCompleted() {
                ...
                if (currentFirstVisibleItem + currentVisibleItemCount >= currentTotalItemCount) {
                    if (this.currentVisibleItemCount > 0
                        ...
                        refreshValue+=1;
                        getNotification(mActivity.p.getString(Pref.PREF_KEY_TOKEN,null),"2",String.valueOf(refreshValue),"10");
                    }
                }
            }
        });
    ...
    public static QuanTamNotificationFragment newInstance(String text) {

        QuanTamNotificationFragment f = new QuanTamNotificationFragment();
        Bundle b = new Bundle();
