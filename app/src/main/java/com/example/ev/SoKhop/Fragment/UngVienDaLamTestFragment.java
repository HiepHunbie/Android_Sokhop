...
public class UngVienDaLamTestFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_ungvien_dalamtest, container, false);
        ...
        getUngVien(p.getString(Pref.PREF_KEY_TOKEN,null),job_id_check,"2",1,"1");
            ...
            private void isScrollCompleted() {
                ...
                if (currentFirstVisibleItem + currentVisibleItemCount >= currentTotalItemCount) {
                    if (this.currentVisibleItemCount > 0
                        ...
                        refreshValue+=1;
                        getUngVien(p.getString(Pref.PREF_KEY_TOKEN,null),job_id_check,"2",1,String.valueOf(refreshValue));
