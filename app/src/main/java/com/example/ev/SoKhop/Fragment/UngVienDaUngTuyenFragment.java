...
public class UngVienDaUngTuyenFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_ungvien_daungtuyen, container, false);
        ...
        getUngVien(p.getString(Pref.PREF_KEY_TOKEN,null),job_id_check,"1",0,"1");
            ...
            private void isScrollCompleted() {
                ...
                if (currentFirstVisibleItem + currentVisibleItemCount >= currentTotalItemCount) {
                    if (this.currentVisibleItemCount > 0
                        ...
                        refreshValue+=1;
                        getUngVien(p.getString(Pref.PREF_KEY_TOKEN,null),job_id_check,"1",0,String.valueOf(refreshValue));
                    }
                }
            }
        });
                ...
                if (httpResponseCode == HttpResponseCode.SUCCESS) {
                    ...
                    try {
                        ...
                        for(int i = 0;i<data.length();i++) {
                            ...
                            if(jsonObjectJobExpect.length()>2){
                        ...
                        if(quanLyUngVienModels.size()>0) {
                            for (int i = refreshValuessss; i < quanLyUngVienModels.size(); i++) {
                                ...
                                other.add(mActivity.getString(R.string.moiphongvan));
